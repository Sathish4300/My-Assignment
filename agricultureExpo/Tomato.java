...
public class Tomato {
	@Test
	public void runTomato() throws AWTException, InterruptedException {
		...
		selectProduct.selectByVisibleText("Tomato");
		// enter quantity
		...
		// enter market price
		driver.findElement(By.xpath("/html/body/app-root/div/app-commen/div/app-commom/div/div/div[2]/div/div[2]/main/div/app-createpost/div[2]/form/div/div[11]/div/input")).sendKeys("20");
		// enter offer price
		driver.findElement(By.xpath("/html/body/app-root/div/app-commen/div/app-commom/div/div/div[2]/div/div[2]/main/div/app-createpost/div[2]/form/div/div[13]/div/input")).sendKeys("16");
		// booking amount
		...
		driver.findElement(By.xpath("/html/body/app-root/div/app-commen/div/app-commom/div/div/div[2]/div/div[2]/main/div/app-createpost/div[2]/form/div/div[19]/div/input")).sendKeys("18");
		// minimal lot
		...
		ele1.click();
		Thread.sleep(3000);
		String file = "C:\\Users\\dinesh\\Downloads\\pexels-pixabay-533280.jpg";
		...
		Thread.sleep(3000);
		String file1 = "C:\\Users\\dinesh\\Downloads\\Tomato videos.mp4";
