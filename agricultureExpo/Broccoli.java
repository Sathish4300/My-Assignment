...
public class Broccoli {
	@Test
	public  void runBroccoli1() throws AWTException, InterruptedException {
		...
		selectProduct.selectByVisibleText("Broccoli");
		// enter quantity
		...
		// enter market price
		driver.findElement(By.xpath("/html/body/app-root/div/app-commen/div/app-commom/div/div/div[2]/div/div[2]/main/div/app-createpost/div[2]/form/div/div[11]/div/input")).sendKeys("60");
		// enter offer price
		driver.findElement(By.xpath("/html/body/app-root/div/app-commen/div/app-commom/div/div/div[2]/div/div[2]/main/div/app-createpost/div[2]/form/div/div[13]/div/input")).sendKeys("45");
		// booking amount
		...
		driver.findElement(By.xpath("/html/body/app-root/div/app-commen/div/app-commom/div/div/div[2]/div/div[2]/main/div/app-createpost/div[2]/form/div/div[19]/div/input")).sendKeys("55");
		// minimal lot
		driver.findElement(By.xpath("/html/body/app-root/div/app-commen/div/app-commom/div/div/div[2]/div/div[2]/main/div/app-createpost/div[2]/form/div/div[21]/div/input")).sendKeys("40");
		// incremental lot
		driver.findElement(By.xpath("/html/body/app-root/div/app-commen/div/app-commom/div/div/div[2]/div/div[2]/main/div/app-createpost/div[2]/form/div/div[23]/div/input")).sendKeys("30");
		// upload photos
		//Thread.sleep(2000);
		WebElement ele1 = driver.findElement(By.xpath("//label[text()='Choose File']"));
		ele1.click();
		Thread.sleep(3000);
		String file = "C:\\Users\\dinesh\\Downloads\\brocoli.jpeg";
		...
		Thread.sleep(3000);
		String file1 = "C:\\Users\\dinesh\\Downloads\\BB_50181b74-831a-4202-b0cb-799489f955c7_FPpreview.mp4";
